...
export const RaceCard = ({ race, selected, done }: { race: Race, selected?: boolean, done?: boolean }) => {
    return <Link href={`/f1/race/${race.round}`} className={`relative bg-gray-800 text-white rounded-md p-3 whitespace-nowrap flex flex-col cursor-pointer hover:bg-gray-700`}>
