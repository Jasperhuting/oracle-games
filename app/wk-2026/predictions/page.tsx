...
export default function PlayerPredictionsPage() {
    ...
    // Team history (H2H + form) keyed by sorted team pair — loaded once from Firestore cache
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
                    {selectedPouleMatches.map((match, index) => {
                        ...
                        const { t1Form, t2Form, h2h, loaded } = resolveHistory(team1.name, team2.name, teamHistory);
                        ...
                        return (
                            <div key={match.id} className="bg-white border-2 border-gray-300 rounded-lg p-4">
                                ...
                                {/* H2H section — only shown when data is loaded from cache */}
                                {loaded && (
                                    <H2HSection headToHead={h2h} team1Name={team1.name} team2Name={team2.name} />
                                )}
                            </div>
                        );
                    })}
