...
export default function SidebarChatWidget() {
  ...
  return (
    <div className="fixed left-0 bottom-0 z-[39] w-[272px] bg-white border-r border-t border-gray-200 shadow-xl rounded-tr-lg overflow-hidden hidden sm:flex sm:flex-col" style={{ top: headerBottom + 8 }}>
      {selectedRoom ? (
        <ChatPanel
          room={selectedRoom}
          user={overlayUser}
