...
interface RiderScriptsSectionProps {
  userId: string;
}

export function RiderScriptsSection({ userId }: RiderScriptsSectionProps) {
  ...
  // Fetch status on mount and after successful additions
  useEffect(() => {
    fetchStatus();
  }, [userId]);
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 mt-5">
      <h2 className="text-xl font-semibold mb-4">
        {t('account.scripts.title') || 'Scripts'}
      </h2>
