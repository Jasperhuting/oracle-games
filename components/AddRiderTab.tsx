      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Punten worden automatisch opgehaald via de scraper</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              PCS Rank (automatisch)
            </label>
            <input
              type="number"
              value={formData.rank}
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded bg-gray-100 text-gray-500 cursor-not-allowed"
            />
            <p className="text-xs text-gray-500 mt-1">Rank wordt automatisch bepaald op basis van de database</p>
          </div>
