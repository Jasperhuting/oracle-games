    ...
    schemas: {
      ...
      CreateGameRequest: {
        ...
        properties: {
          ...
          gameType: {
            type: 'string',
            enum: ['auctioneer', 'slipstream', 'last-man-standing', 'poisoned-cup', 'nations-cup', 'rising-stars', 'country-roads', 'worldtour-manager', 'fan-flandrien', 'full-grid', 'marginal-gains', 'f1-prediction'],
          },
